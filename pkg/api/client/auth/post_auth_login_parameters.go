...
type PostAuthLoginParams struct {
	...
	/* Login.
	   ...
	   Login payload
	*/
	Login *models.GithubComFlotioDevCoreAPIInternalModulesUserModelLoginRequest
...
// WithLogin adds the login to the post auth login params.
func (o *PostAuthLoginParams) WithLogin(login *models.GithubComFlotioDevCoreAPIInternalModulesUserModelLoginRequest) *PostAuthLoginParams {
	o.SetLogin(login)
	return o
}

// SetLogin adds the login to the post auth login params.
func (o *PostAuthLoginParams) SetLogin(login *models.GithubComFlotioDevCoreAPIInternalModulesUserModelLoginRequest) {
	o.Login = login
}
