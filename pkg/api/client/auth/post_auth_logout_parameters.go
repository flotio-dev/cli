...
type PostAuthLogoutParams struct {
	...
	*/
	Logout *models.GithubComFlotioDevCoreAPIInternalModulesUserModelRefreshTokenRequest
...
// WithLogout adds the logout to the post auth logout params.
func (o *PostAuthLogoutParams) WithLogout(logout *models.GithubComFlotioDevCoreAPIInternalModulesUserModelRefreshTokenRequest) *PostAuthLogoutParams {
	o.SetLogout(logout)
	return o
}

// SetLogout adds the logout to the post auth logout params.
func (o *PostAuthLogoutParams) SetLogout(logout *models.GithubComFlotioDevCoreAPIInternalModulesUserModelRefreshTokenRequest) {
	o.Logout = logout
}
